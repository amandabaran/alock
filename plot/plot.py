...
parser.add_argument('resfile', type=str, default='exp_result.csv', help='Name of file with results')
...
def aggregate_results(df):
    ...
    merged_csv_path = os.path.join(FLAGS.save_dir, 'results.csv')
...
def merge_csv_results(root_dir):
    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        if FLAGS.resfile in filenames:
            csv_file_path = os.path.join(dirpath, FLAGS.resfile)
